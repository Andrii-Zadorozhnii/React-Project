    ...
    return (
        <footer className="footer">
            <div className="footer-logo">
                <NavLink to='/home' className="main-footer__logo">
                        ...
                        <svg viewBox="0 0 36 52"
                            ...
                            fill="#EC1D24" width="100%" height="100%"></rect><path fill="#FEFEFE"
                                                                                   d="M31.5 48V4H21.291l-3.64 22.735L14.102 4H4v44h8V26.792L15.577 48h4.229l3.568-21.208V48z"></path></svg></span></NavLink>
            </div>

            <ul className='footer-nav'>
                {footerNav.map(navItem => (
                    <li className='footer-nav__item' key={navItem}><NavLink to={navItem} className='footer-nav__item-link'
                                                                            >{navItem}</NavLink></li>
                ))}
            </ul>
            <ul className='footer-nav'>
                {footerNav2.map(navItem2 => (
                    <li className='footer-nav__item' key={navItem2}><NavLink to={navItem2} className='footer-nav__item-link'
                                                                       >{navItem2}</NavLink></li>
                ))}
            </ul>
            ...
            <div className='footer-promotion'>
                <div className="main-footer__promotion">
                    <NavLink to='/insider' className="main-footer__promotion-link">
                ...
                <div className="main-footer__promotion">
                    <NavLink to='/promotional' className="main-footer__promotion-link">
